...
import { Eye, EyeOff, ArrowLeft, User, Calendar, MessageSquare, CreditCard, Settings, Bell } from "lucide-react"
...
export default function KundeLoginPage() {
  ...
  const fillDemoCredentials = () => {
    ...
    if (form) {
      ;(form.elements.namedItem("email") as HTMLInputElement).value = "kunde@example.com"
  ...
  const quickActions = [
    {
      icon: Calendar,
      title: "Termine",
      description: "Ihre gebuchten Termine",
      href: "/dashboard/kunde/termine",
      color: "bg-petrol-100 text-petrol-600",
    },
    {
      icon: MessageSquare,
      title: "Nachrichten",
      description: "Kommunikation mit Dolmetschern",
      href: "/dashboard/kunde/nachrichten",
      color: "bg-apricot-100 text-apricot-600",
    },
    {
      icon: CreditCard,
      title: "Zahlungen",
      description: "Rechnungen & Zahlungsmethoden",
      href: "/dashboard/kunde/zahlungen",
    ...
    },
    {
      ...
      href: "/dashboard/kunde/einstellungen",
      color: "bg-purple-100 text-purple-600",
    },
    {
      icon: Bell,
      title: "Benachrichtigungen",
      description: "Ihre Benachrichtigungen",
      href: "/dashboard/kunde/benachrichtigungen",
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-petrol-50 to-petrol-100 flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 bg-white/80 backdrop-blur-sm sticky top-0 z-10">
        ...
        <h1 className="text-lg font-semibold text-gray-900">Kunden-Login</h1>
        <div className="w-10" />
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-4 py-8">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Melden Sie sich in Ihr Kundenportal an</p>
          </div>

          {/* Demo Credentials Banner */}
          <div className="bg-petrol-50 border border-petrol-200 rounded-lg p-3 mb-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-petrol-800">Demo-Zugang testen</p>
                <p className="text-xs text-petrol-600">kunde@example.com</p>
              </div>
              <Button
                variant="outline"
                size="sm"
                onClick={fillDemoCredentials}
                className="border-petrol-300 text-petrol-700 hover:bg-petrol-100 bg-transparent"
              >
                Ausfüllen
              </Button>
            </div>
          ...
          <form id="login-form" action={formAction} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/passwort-vergessen" className="text-sm text-petrol-600 hover:text-petrol-700 font-medium">
                Passwort vergessen?
              </Link>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-petrol-50 text-gray-500">Oder anmelden mit</span>
              </div>
            </div>
            <div className="mt-4">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              Noch kein Kunden-Account?{" "}
              <Link href="/registrieren?type=kunde" className="text-petrol-600 hover:text-petrol-700 font-semibold">
                Jetzt registrieren
              </Link>
            </p>
          </div>
