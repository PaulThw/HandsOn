...
export default function KrankenkasseRegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 bg-white/80 backdrop-blur-sm sticky top-0 z-10">
        ...
        <h1 className="text-lg font-semibold text-gray-900">Krankenkassen-Registrierung</h1>
        <div className="w-10" />
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-4 py-8">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Partnerschaft beantragen</h2>
            <p className="text-gray-600">Werden Sie unser Kostenträger-Partner</p>
          </div>
          ...
          <form action={formAction} className="space-y-6">
            <input type="hidden" name="role" value="krankenkasse" />
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="terms" className="text-sm text-gray-600">
                  Ich stimme den{" "}
                  <Link href="/agb" className="text-green-600 hover:text-green-700 font-medium">
                    AGB
                  </Link>{" "}
                  und der{" "}
                  <Link href="/datenschutz" className="text-green-600 hover:text-green-700 font-medium">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-green-50 text-gray-500">Oder registrieren mit</span>
              </div>
            </div>
            <div className="mt-4">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              Bereits registriert?{" "}
              <Link href="/login/krankenkasse" className="text-green-600 hover:text-green-700 font-semibold">
                Jetzt anmelden
              </Link>
            </p>
          </div>
